...
public class GImplMethodFilter {
     ...
     */
    private static final List<Method> UNIMPLEMENTABLE_METHODS = Arrays.asList(
        new Method("com.google.android.gms.common.api.ResultCallbacks", "onResult"),
        ...
        new Method("com.google.android.gms.identity.intents.model.CountrySpecification", "describeContents"),
        ...
        new Method("com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialRpEntity", "describeContents"),
        new Method("com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialDescriptor", "describeContents"),
        new Method("com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialType", "describeContents"),
        new Method("com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialUserEntity", "describeContents"),
        new Method("com.google.android.gms.fido.fido2.api.common.PublicKeyCredentialParameters", "describeContents"),
        new Method("com.google.firebase.messaging.FirebaseMessagingService", "onBind"));
