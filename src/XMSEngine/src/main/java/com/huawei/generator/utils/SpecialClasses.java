...
/**
 * A hard-coded util class to indicate whether we should generate G and H instances
...
public class SpecialClasses {
    private static final List<String> ONLY_FOR_WRAPPING = Arrays.asList(
        ...
        "org.xms.libraries.places.api.model.OpeningHours.Builder", "org.xms.libraries.places.api.model.Place.Builder",
        ...
        "org.xms.libraries.places.api.net.FetchPlaceRequest.Builder", "org.xms.f.messaging.RemoteMessage",   // Builder
        ...
        "org.xms.libraries.places.api.model.AutocompletePrediction", "org.xms.libraries.places.api.model.PhotoMetadata",
        ...
        "org.xms.g.tasks.CancellationToken", "org.xms.g.tasks.CancellationTokenSource",
        "org.xms.g.tasks.TaskCompletionSource", "org.xms.g.tasks.Task",
        "org.xms.g.auth.api.Auth.AuthCredentialsOptions.Builder",
        "org.xms.g.games.leaderboard.ScoreSubmissionData.Result", "org.xms.g.common.api.PendingResult",
        "org.xms.g.common.ErrorDialogFragment", "org.xms.g.common.SupportErrorDialogFragment");

    private static final List<String> NOT_FOR_USER_INHERITING = Arrays.asList("org.xms.g.common.data.DataBuffer",
        "org.xms.g.games.achievement.Achievement", "org.xms.g.games.org.xms.g.games.org.xms.g.games.Games",
        "org.xms.g.games.snapshot.SnapshotMetadata", "org.xms.g.games.stats.PlayerStats",
        "org.xms.g.games.snapshot.SnapshotMetadataChange", "org.xms.g.games.snapshot.SnapshotContents",
        "org.xms.g.games.event.Event", "org.xms.g.games.Game", "org.xms.g.games.leaderboard.Leaderboard",
        "org.xms.g.games.leaderboard.LeaderboardScore", "org.xms.g.games.leaderboard.LeaderboardVariant",
        "org.xms.g.games.Player", "org.xms.g.common.api.PendingResult");
