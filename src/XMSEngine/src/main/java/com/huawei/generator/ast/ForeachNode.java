...
public class ForeachNode extends BraceNode {
    ...
    public static ForeachNode create(DeclareNode declareNode, StatementNode statementNode, BlockNode body) {
        ForeachNode foreachNode = new ForeachNode();
        foreachNode.declareNode = declareNode;
        foreachNode.statementNode = statementNode;
