...
/**
 * The top level changer of G2H, and it decides what changer G2H should contains and what's order of them.
 *
 * @since 2020-04-22
 */
public class G2HAutoChanger extends BaseAutoChanger {
    @Override
    protected void initializeAtomicFixers() throws CodeBotRuntimeException {
        this.atomicFixers.add(new G2HFirstPhaseChanger(FIXER_TYPE_G2H));
        this.atomicFixers.add(new GradleWarningChanger(FIXER_TYPE_G2H));
        this.atomicFixers.add(new ComplexStartupActivityChanger(FIXER_TYPE_G2H));
        this.atomicFixers.add(new ConditionalChanger(FIXER_TYPE_G2H));
        ...
        this.atomicFixers.add(new PackageDeleteChanger(FIXER_TYPE_G2H));
    }
    ...
    public FixerInfo getFixerInfo() {
        if (this.info == null) {
            ...
            info.type = DefectFixerType.fromValue(FIXER_TYPE_G2H);
