...
public class StructGradleHeadquarter {
    ...
    private StructSpecialAdd specialAddInDependency;

    private StructSpecialAdd structSpecialAddInApp;

    private StructVersionWarnings versionWarnings;

    private StructSpecialAdd allProjectsInfo;
    ...
    public StructGradleHeadquarter() {
        ...
        setSpecialAddInDependency(new StructSpecialAdd());
        setSpecialAddInApp(new StructSpecialAdd());
        setVersionWarnings(new StructVersionWarnings());
        setAllProjectsInfo(new StructSpecialAdd());
    }
     ...
     */
    public StructSpecialAdd getSpecialAddInDependency() {
        return specialAddInDependency;
    }

    public void setSpecialAddInDependency(StructSpecialAdd specialAddInDependency) {
        this.specialAddInDependency = specialAddInDependency;
    }

    public StructSpecialAdd getSpecialAddInApp() {
        return structSpecialAddInApp;
    }

    public void setSpecialAddInApp(StructSpecialAdd structSpecialAddInApp) {
        this.structSpecialAddInApp = structSpecialAddInApp;
    }

    public StructVersionWarnings getVersionWarnings() {
        return versionWarnings;
    }

    public void setVersionWarnings(StructVersionWarnings versionWarnings) {
        this.versionWarnings = versionWarnings;
    }

    public StructSpecialAdd getAllProjectsInfo() {
        return allProjectsInfo;
    }

    public void setAllProjectsInfo(StructSpecialAdd allProjectsInfo) {
